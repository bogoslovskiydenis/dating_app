...
class DatabaseRepository extends BaseDatabaseRepository {
  ...
  Future<void> updateUserPictires(User user, String imageName) async {
    ...
    return _firebaseFirestore.collection('users').doc('8DxzlUk5wEvUSi5jHq7x').update({
  ...
  Future<void> createUser(User user) async {
    await _firebaseFirestore.collection('users').doc('8DxzlUk5wEvUSi5jHq7x').set(user.toMap());
  }
